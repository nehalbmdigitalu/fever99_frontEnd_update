...
function AdminService() {
  const [query, setQuery] = useState({ page: 1, size: 24, role: ROLES.DOCTOR });
  const { ItemList, ItemTotalPage } = useSelector((state) => state.service);
        ...
        <div className="content">
          ...
          >
            <div className="col-sm-4 col-3">
              <h4 className="page-title">Sercice</h4>
            </div>
            <div
